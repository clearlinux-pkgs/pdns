...
Source0  : https://downloads.powerdns.com/releases/pdns-4.6.0.tar.bz2
Source1  : https://downloads.powerdns.com/releases/pdns-4.6.0.tar.bz2.asc
...
%prep
%setup -q -n pdns-4.6.0
cd %{_builddir}/pdns-4.6.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645125677
...
cp %{_builddir}/pdns-4.6.0/COPYING %{buildroot}/usr/share/package-licenses/pdns/1d8c93712cbc9117a9e55a7ff86cebd066c8bfd8
cp %{_builddir}/pdns-4.6.0/NOTICE %{buildroot}/usr/share/package-licenses/pdns/b0546213f9970e01098f0ec919c828d83790eb9a
cp %{_builddir}/pdns-4.6.0/ext/ipcrypt/LICENSE %{buildroot}/usr/share/package-licenses/pdns/8f5d9d5ea232b642dd53df820acf167e9086d119
cp %{_builddir}/pdns-4.6.0/ext/protozero/LICENSE.from_folly %{buildroot}/usr/share/package-licenses/pdns/598f87f072f66e2269dd6919292b2934dbb20492
cp %{_builddir}/pdns-4.6.0/ext/protozero/LICENSE.md %{buildroot}/usr/share/package-licenses/pdns/c90134f68ba9b55008f8dc3dd3100e2e632d55bf
cp %{_builddir}/pdns-4.6.0/ext/yahttp/LICENSE %{buildroot}/usr/share/package-licenses/pdns/cd4a6679c43eb8c0331ebc91648b27b6fd747252
%make_install
