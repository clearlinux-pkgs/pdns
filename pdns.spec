...
Source0  : https://downloads.powerdns.com/releases/pdns-4.9.1.tar.bz2
Source1  : https://downloads.powerdns.com/releases/pdns-4.9.1.tar.bz2.asc
...
%setup -q -n pdns-4.9.1
cd %{_builddir}/pdns-4.9.1
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a pdns-4.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718864623
